...
public interface IGridData {
    ...
    /**
     * Whether rows can be repositioned by dragging and dropping.
    ...
    /**
     * Whether columns can be repositioned by dragging and dropping.
     * @return true if drag and drop is enabled.
     */
    boolean isColumnDraggingEnabled();

    /**
     * Set whether columns can be repositioned by dragging and dropping.
     * @param enabled true if drag and drop is enabled.
     */
