 ...
 * to miss receipt of Events. It also restricts movement to a defined "boundary".
 */
public class RestrictedMousePanMediator extends AbstractMediator {
    ...
    public RestrictedMousePanMediator( final IGridLayer gridLayer ) {
    ...
    public void setRestriction( final IRestriction restriction ) {
    ...
    protected void onMouseMove( final NodeMouseMoveEvent event ) {
        ...
        Transform newTransform = getTransform().copy().translate( deltaX,
                                                                  deltaY );
        if ( restriction != null ) {
            newTransform = restriction.adjust( newTransform,
