...
import org.uberfire.ext.wires.core.grids.client.widget.pinning.GridPinnedModeManager;
...
public class GridLayer extends Layer implements IGridLayer {
    ...
    private final GridPinnedModeManager pinnedModeManager = new GridPinnedModeManager( this,
                                                                                       new BoundaryRestriction() );
    ...
    private void flipToGridWidget( final IBaseGridWidget gridWidget ) {
    ...
    private void scrollToGridWidget( final IBaseGridWidget gridWidget ) {
    ...
    public IRestriction getDefaultRestriction() {
        return pinnedModeManager.getDefaultRestriction();
    }

    @Override
    public IBounds getVisibleBounds() {
        updateVisibleBounds();
        return bounds;
    }
